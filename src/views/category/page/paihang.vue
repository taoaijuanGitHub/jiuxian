    ...
    <el-row style="margin-top:40px" class="banner">
      <el-col :span="24">
        <a style="display:block;background:#f5f5f5">
          <img src="https://img09.jiuxian.com/bill/2017/0930/3b6a061687294dadb1b3b486d9496eb0.jpg" />
        </a>
      </el-col>
    </el-row>
      ...
      <div class="banner">
        <el-row>
          <el-col :span="24">
            <a href>
              <img
                src="https://img07.jiuxian.com/bill/2017/0930/e64a684fb7f84d7db9cd6d1c62005d08.jpg"
              />
            </a>
          </el-col>
        </el-row>
      ...
      <div class="banner">
        <el-row>
          <el-col :span="24">
            <a href>
              <img
                src="https://img06.jiuxian.com/bill/2017/0930/f41685a5cde2441d90ed7ac13c4c42cb.jpg"
              />
            </a>
          </el-col>
        </el-row>
      ...
      <div class="banner">
        <el-row>
          <el-col :span="24">
            <a href>
              <img
                src="https://img09.jiuxian.com/bill/2017/0930/6202dcde4a134ecea59f266e1b24a2a7.jpg"
              />
            </a>
          </el-col>
        </el-row>
